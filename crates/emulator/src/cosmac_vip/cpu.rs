...
impl Cpu {
    ...
    pub fn cycle(&mut self, keypad_state: Keypad) -> CycleOutput {
...
#[cfg(test)]
mod tests {
    use crate::cosmac_vip::display::DisplayBuffer;
    use crate::cosmac_vip::keypad::Keypad;
    use crate::cosmac_vip::memory::{Memory, USER_SPACE_STR};
    use crate::cosmac_vip::registers::Registers;
    use crate::cosmac_vip::stack::Stack;
    ...
    fn new_instance() {
        ...
        assert_eq!(cpu.keypad, Keypad::new());
    ...
    fn instr_key_op_vx_not_pressed_no_skip() {
        ...
        cpu.keypad[9] = true;
        cpu.registers[0x5] = 9;
        cpu.execute(crate::cosmac_vip::opcode::Instruction::KeyOpVxNotPressed(
            0x5,
        ));
